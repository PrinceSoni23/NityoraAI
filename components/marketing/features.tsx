        ...
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    Smarter Analytics through  <br /> inhouse <span className="font-subheading italic">AI automation</span>
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                    Enhance your Analytics with AI-powered automation. Build insights faster, Real-Time Data Processing, and make smarter decisions instantly.
                    </p>
                </div>
            </Container>
