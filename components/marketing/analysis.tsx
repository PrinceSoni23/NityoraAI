        ...
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            <Container>
                <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-16">
                    ...
                    Predictive Insights  <br /><span className="font-subheading italic">dashboard</span>
                    </h2>
                    <p className="text-base md:text-lg text-accent-foreground/80 mt-4">
                    Unlock deep insights into your marketing performance and campaign metrics with our powerful analytics tools.
                    </p>
                </div>
            </Container>
                    ...
                    <div className="rounded-2xl bg-background/40 relative border border-border/50">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                Analyze your Company performance with real-time insights
                                </p>
                    ...
                    <div className="rounded-2xl bg-background/40 relative border border-border/50">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-sm text-muted-foreground">
                                Understand Customers interests and engagement levels.
                                </p>
