            ...
            <div className="flex flex-col items-center justify-center gap-y-8 relative">
                ...
                <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
                    ...
                    <Container delay={0.15}>
                        <h1 className="text-4xl md:text-4xl lg:text-7xl font-bold text-center mt-7 !leading-tight max-w-4xl mx-auto">
                    ...
                    <Container delay={0.2}>
                        ...
                        Smart AI automation and insights to refine your campaigns and boost your brand growth
                        </p>
                    </Container>
                    ...
                    <Container delay={0.3} className="relative">
                        <div className="relative rounded-xl lg:rounded-[32px] border border-border p-2 backdrop-blur-lg mt-10 max-w-6xl mx-auto">
                            <div className="absolute top-1/8 left-1/2 -z-10 bg-gradient-to-r from-sky-200 to-blue-900 w-1/2 lg:w-3/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[4rem] lg:blur-[10rem] animate-image-glow"></div>
