...
import { REVIEWS } from "../main/utils/constants/misc";
                ...
                <div className="mt-16 w-full relative overflow-hidden">
                    <div className="relative flex flex-col items-center justify-center overflow-hidden">
                        <Marquee pauseOnHover className="[--duration:30s]">
                            {firstRow.map((review) => (
                                <ReviewCard key={review.username} img={review.avatar} name={review.name} username={review.username} review={review.review} />
                            ))}
                        </Marquee>
