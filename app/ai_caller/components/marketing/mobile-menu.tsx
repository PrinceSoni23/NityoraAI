...
// Update the path below to the correct relative path where useClickOutside is defined, for example:
...
function useClickOutside<T extends HTMLElement = HTMLDivElement>(handler: () => void) {
