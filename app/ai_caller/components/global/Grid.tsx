...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      ...
      <div className="absolute bottom-0 z-40 inset-x-0 h-60 bg-gradient-to-t from-transparent dark:from-black via-black dark:via-black to-transparent w-full pointer-events-none" />
